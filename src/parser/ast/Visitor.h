...
class ASTStatementStructDecl;
class ASTStatementStructInit;
...
public:
    ...
    virtual void visit(ASTStatementStructDecl* decl) = 0;
    virtual void visit(ASTStatementStructInit* init) = 0;
};
